...
같은 방식으로 재구성하고 계획서(``web/docs/polymarket-dashboard.md`` 7-4)의 상한과
...
from web.polymarket.dashboard.models import normalize_event  # noqa: E402
from web.polymarket.dashboard.storage import MAX_MANIFEST_BYTES  # noqa: E402
