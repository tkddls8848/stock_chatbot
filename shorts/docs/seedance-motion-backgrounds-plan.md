...
- 상태: **단계 1~4 구현 완료(2026-09-26, 기본 꺼짐).** 결정 대기 1·2·4는 권장안(fal·8초 fast·
  기본 false)으로 정했다. 남은 일은 fal 키 발급 → `SHORTS_GENERATED_CLIPS=true` → 운영 서버
  사흘 치 실측(아래 검증 기준)과 단계 5(음악) 결정이다. 실측이 끝나면 이 계획서를 지운다
