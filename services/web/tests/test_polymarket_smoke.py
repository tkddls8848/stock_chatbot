...
이력 경로가 철수했고(services/web/docs/polymarket-dashboard.md 10-3), 현재 대시보드는
지금 열린 event만 본다.
"""
...
from services.web.core.config import POLYMARKET_BASE_URL, POLYMARKET_PROXY_URL, POLYMARKET_TIMEOUT
