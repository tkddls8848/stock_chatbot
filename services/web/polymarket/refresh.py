...
from services.web.polymarket.dashboard.client import EventsClient
from services.web.polymarket.dashboard.models import normalize_event
from services.web.polymarket.dashboard.storage import write_generation
from services.web.polymarket.dashboard.taxonomy import (
    CATEGORY_LABELS,
    NAMED_CATEGORY_TARGET,
    TAXONOMY_VERSION,
)
from services.web.polymarket.dashboard.transport import build_session
...
# (services/web/pages.py의 `slice(0,200)`) 그 아래는 아무도 읽지 않는다. 전부 담으면
