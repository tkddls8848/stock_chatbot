...
from services.telegram_bot.core.config import TELEGRAM_CHAT_ID
from services.telegram_bot.handlers.navigation import handle_menu_callback, persistent_menu
