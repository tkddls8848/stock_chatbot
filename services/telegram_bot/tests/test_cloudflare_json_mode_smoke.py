...
python -m pytest -q -s -m cloudflare_smoke services/telegram_bot/tests/test_cloudflare_json_mode_smoke.py
```
...
from services.telegram_bot.llm.backends import CloudflareWorkersAIBackend, LLMBackendError
from services.telegram_bot.llm.news_report import RESPONSE_SCHEMA as REPORT_SCHEMA
