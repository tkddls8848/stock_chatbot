...
from telegram_bot.watchlist.handlers import cmd_menu, handle_watchlist_callback
from telegram_bot.watchlist.keyboards import build_list_keyboard
...
def test_bot_startup_pushes_latest_persistent_menu(monkeypatch):
    ...
    monkeypatch.setattr("telegram_bot.handlers.commands.TELEGRAM_CHAT_ID", "chat")
